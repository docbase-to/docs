...
<Info>
  Note on Jitter: To prevent overwhelming your servers, Docbase adds a random "jitter" of up to 5 minutes to each of these delayed attempts.
</Info>

## Standard Payload Structure

Every webhook sent by Docbase follows this exact JSON structure. T**he Data object will vary depending on the EventType.**
